...
public class DeleteContractHttpResponseHandler extends
		BaseJsonHttpResponseHandler<JsonResult<String>> {
	IShowData<JsonResult<String>> mShowData=null;

	public DeleteContractHttpResponseHandler(IShowData<JsonResult<String>> showData ){
		mShowData = showData;
	}
