...
public class DeleteAllContractHttpResponseHandler extends BaseJsonHttpResponseHandler<JsonResult<String>> {
	IShowData<JsonResult<String>> mShowData=null;

	public DeleteAllContractHttpResponseHandler ( IShowData<JsonResult<String>> showData){
		mShowData =showData;
	}
